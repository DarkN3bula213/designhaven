    ...
    <div className=" py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-base font-semibold leading-7 text-brand2">
            Pricing
          </h2>
          ...
          >
            ...
            {frequencies.map((option) => (
              <RadioGroup.Option
                ...
                className={({ checked }) =>
                  classNames(
                    checked ? '!bg-brand2' : 'text-gray-900',
          ...
          {tiers.map((tier) => (
            <div
              ...
              className={classNames(
                tier.mostPopular
                  ? 'bg-white/5 ring-2 ring-brand2'
                  : 'ring-1 ring-brand2/20',
            ...
            >
              <div className="flex items-center justify-between gap-x-4   ">
                ...
                {tier.mostPopular ? (
                  <p className="text-white rounded-full bg-brand2 px-2.5 py-1 text-xs font-semibold leading-5">
                    Most popular
                  </p>
                ) : null}
              </div>
              ...
              <a
                ...
                className={clsx(
                  tier.mostPopular
                    ? 'bg-brand2 text-white shadow-sm hover:bg-brand2/75 focus-visible:outline-indigo-500'
                    : 'bg-black/25 text-gray-900 hover:bg-white/20 focus-visible:outline-white',
              ...
              >
                {tier.features.map((feature) => (
                  <li key={feature} className="flex gap-x-3">
                    <CheckIcon
                      className="h-6 w-5 flex-none text-brand2"
                      aria-hidden="true"
                    />
                    {feature}
                  </li>
