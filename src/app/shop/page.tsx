...
import { perks } from '@/constants/shopping'
...
const categories = [
  {
    name: 'Accessories',
    href: '/shop/product',
    imageSrc: '/collectors-pen.jpeg',
  },
  {
    name: 'Productivity',
    href: '#',
    imageSrc: 'wall-cab.jpeg',
  },
  {
    name: 'Lighting',
    href: '#',
    imageSrc: 'table-lamp.jpeg',
  },
  {
    name: 'Sitting',
    href: '#',
          ...
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              {/* <img
                ...
                className="h-full w-full object-cover object-center"
              /> */}
              <Image height={500} width={800} src="/study.jpg" alt=".." />
            </div>
          ...
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              {/* <img
                ...
                className="h-full w-full object-cover object-center"
              /> */}
              <Image height={500} width={800} src="/wardrobe.jpg" alt=".." />
            </div>
            <div className="relative bg-gray-900 bg-opacity-75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
              <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                <h2
                ...
                <p className="mt-3 text-xl text-white">
                  ...
                  boards,   charts, or tangled flowcharts with our Focus
