  ...
  return (
    <div className="px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        <p className="text-base font-semibold leading-7 text-brand2">Introducing</p>
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              <CheckCircle className="mt-1 h-5 w-5 flex-none text-brand2" aria-hidden="true" />
              <span>
          ...
          <figure className="mt-10 border-l border-bratext-brand2 pl-9">
        ...
        <figure className="mt-16">
          ...
          <figcaption className="mt-4 flex gap-x-2 text-sm leading-6 text-gray-500">
            <InfoCircle className="mt-0.5 h-5 w-5 flex-none text-gray-300" aria-hidden="true" />
